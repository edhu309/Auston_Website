...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-40 -top-40 h-[520px] w-[520px] rounded-full bg-[#F7C600]/[0.07] blur-[130px]"
      />
          ...
          <div className="relative mx-auto w-full max-w-xl lg:mx-0 lg:ml-auto">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.12] bg-white/[0.055] p-3 shadow-2xl shadow-black/20 backdrop-blur-sm sm:p-4">
              ...
              <div className="relative min-h-[390px] overflow-hidden rounded-[1.5rem] bg-[#0B2A4A] sm:min-h-[450px]">
                ...
                <div className="absolute left-5 top-5 rounded-2xl border border-white/10 bg-[#071B35]/85 px-4 py-3 shadow-xl backdrop-blur-md sm:left-7 sm:top-7">
                ...
                <div className="absolute bottom-5 right-5 rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 backdrop-blur-md sm:bottom-7 sm:right-7">
