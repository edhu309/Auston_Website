          ...
          {industries.map((industry, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={industry.href}
                  className={`group relative block h-full overflow-hidden rounded-3xl border p-6 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1.5 ${
                    industry.featured
                      ? "border-[#123B63] bg-[#071B35] text-white shadow-xl shadow-[#071B35]/10"
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col">
                    ...
                    {/* Explore link */}
                    <div
                      className={`mt-auto flex items-center gap-2 pt-7 text-sm font-bold ${
                        industry.featured
                          ? "text-[#F7C600]"
