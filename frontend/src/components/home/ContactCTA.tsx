  ...
  return (
    ...
    >
      ...
      <Float
        duration={4}
        distance={5}
        className="pointer-events-none absolute right-[14%] top-[24%] hidden lg:block"
      >
        <div
          aria-hidden="true"
        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-16">
          ...
          <Reveal duration={0.7} y={30}>
            <div className="max-w-3xl">
              ...
              <Reveal delay={0.15} duration={0.65} y={20}>
          ...
          <Reveal delay={0.12} duration={0.7} y={30}>
            <div className="relative">
              ...
              <div
                aria-hidden="true"
                className="pointer-events-none absolute -inset-4 rounded-[2.5rem] bg-[#F7C600]/[0.04] blur-2xl"
              />

              <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.1] bg-white/[0.055] p-6 shadow-2xl shadow-black/20 backdrop-blur-sm transition-all duration-500 hover:border-white/[0.16] hover:bg-white/[0.065] sm:p-7">
                {/* Top accent */}
                <div
                  aria-hidden="true"
                  className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-[#F7C600]/60 to-transparent"
                />

                {/* Header */}
                <div className="flex items-center gap-3 border-b border-white/[0.1] pb-6">
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#F7C600] shadow-lg shadow-[#F7C600]/10 transition-transform duration-300 hover:scale-105">
                    <Sparkles
                      aria-hidden="true"
                ...
                <div className="mt-6 space-y-5">
                  <a
                    ...
                    className="group flex items-start gap-4 rounded-2xl p-2 -mx-2 transition-colors duration-300 hover:bg-white/[0.04]"
                  >
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/[0.06] transition-all duration-300 group-hover:bg-[#F7C600]">
                      <Phone
                        aria-hidden="true"
                        className="h-4 w-4 text-[#F7C600] transition-colors duration-300 group-hover:text-[#071B35]"
                      />
                    </div>
                  ...
                  <div className="flex items-start gap-4 rounded-2xl p-2 -mx-2">
                ...
                <div className="mt-7 border-t border-white/[0.1] pt-5">
                  <p className="text-xs leading-5 text-white/35">
                    Professional hygiene and cleaning solutions for
                    hospitality, healthcare, food & beverage, commercial and
