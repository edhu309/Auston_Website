...
export const metadata: Metadata = {
  title: "Food & Beverage Hygiene Solutions",
  description:
    "Professional cleaning, hygiene and facility solutions for food and beverage businesses from Auston, supporting kitchens, dining areas, production spaces and commercial facilities.",
  alternates: {
    canonical: "/industries/food-beverages",
  },
};
...
const solutions = [
  {
    ...
    description:
      "Professional cleaning solutions for commercial kitchens, food-service areas and everyday back-of-house operations.",
  },
  {
    icon: Droplets,
    title: "Surface & Floor Care",
    description:
      "Cleaning products supporting routine maintenance of floors, surfaces and high-use areas.",
  },
  {
    icon: Warehouse,
    title: "Facility Cleaning",
    description:
      "Solutions for maintaining clean and well-managed food-service, storage and operational environments.",
  },
  {
    icon: Sparkles,
    title: "General Hygiene",
    description:
      "A broad range of professional hygiene products supporting day-to-day cleaning requirements.",
  },
];
    ...
    <main className="bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28">
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-3xl text-base leading-7 text-white/70 sm:text-lg sm:leading-8">
              ...
              solutions for restaurants, commercial kitchens, food-service
              operations and other food and beverage environments.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-12">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
              Clean operations start with the right hygiene solutions.
            </h2>

            <p className="mt-5 text-base leading-7 text-gray-600">
              Food and beverage environments involve kitchens, dining areas,
              service spaces, storage areas, washrooms and other operational
              spaces that require regular cleaning and maintenance.
            </p>

            <p className="mt-5 text-base leading-7 text-gray-600">
              Auston&apos;s professional product portfolio supports routine
              cleaning and hygiene requirements across these different
              environments.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-[#F7F9FC] p-8 sm:p-10">
            ...
            <h3 className="mt-6 text-2xl font-bold tracking-tight text-[#071B35]">
              Hygiene across the food-service environment.
            </h3>

            <p className="mt-4 text-sm leading-6 text-gray-600">
              From commercial kitchens and dining areas to floors, washrooms
              and back-of-house spaces, professional cleaning products can
              support consistent facility-care routines.
            </p>
      ...
      <section className="bg-[#F7F9FC] py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
              Supporting everyday food-service hygiene.
            </h2>

            <p className="mt-5 text-base leading-7 text-gray-600">
              A professional hygiene portfolio helps teams address different
              cleaning requirements throughout food and beverage operations.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
                Solutions for different food-service requirements.
              </h2>

              <p className="mt-5 text-base leading-7 text-gray-600">
                Every food and beverage operation has its own workflows and
                facility requirements. Auston supports a broad range of
                routine cleaning and hygiene needs.
              </p>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Professional products for food-service teams.
              </h2>
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
              Supporting food-service teams from requirement to solution.
            </h2>
            ...
            {[
              {
                ...
                title: "Understand",
                description:
                  "Identify the areas, workflows and cleaning requirements within the operation.",
              },
              {
                number: "02",
                icon: Droplets,
                title: "Explore",
                description:
                  "Review suitable product categories for the required cleaning and hygiene tasks.",
              },
              {
                number: "03",
                icon: CheckCircle2,
                title: "Connect",
                description:
                  "Discuss your requirements with Auston and identify suitable next steps.",
              },
            ].map((step) => {
      ...
      <section className="bg-[#F7F9FC] py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-6 text-center sm:px-8">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
            Looking for professional food-service hygiene solutions?
          </h2>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-gray-600">
            ...
            discuss your kitchen, food-service and facility-care requirements.
          </p>
