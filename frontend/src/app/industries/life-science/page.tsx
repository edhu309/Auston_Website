...
export const metadata: Metadata = {
  title: "Life Science Hygiene Solutions",
  description:
    "Professional cleaning, hygiene and facility-care solutions for life science environments from Auston.",
  alternates: {
    canonical: "/industries/life-science",
  },
};
...
const solutions = [
  {
    ...
    description:
      "Professional cleaning solutions supporting routine maintenance of specialised and controlled work environments.",
  },
  {
    icon: Droplets,
    title: "Surface & Floor Care",
    description:
      "Products supporting cleaning and maintenance of floors, surfaces and other facility areas.",
  },
  {
    icon: FlaskConical,
    title: "Facility Hygiene",
    description:
      "A professional portfolio supporting hygiene requirements across life science facilities and operational spaces.",
  },
  {
    icon: Activity,
    title: "Operational Support",
    description:
      "Cleaning tools, equipment and hygiene essentials supporting everyday facility-care activities.",
  },
];
    ...
    <main className="bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28">
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-3xl text-base leading-7 text-white/70 sm:text-lg sm:leading-8">
              ...
              solutions to support the routine maintenance requirements of
              life science environments.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-12">
          <div>
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#F59E0B]">
              Life Science Hygiene
            </span>

            <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
              Supporting clean and well-maintained specialised environments.
            </h2>

            <p className="mt-5 text-base leading-7 text-gray-600">
              Life science environments can include specialised workspaces,
              laboratories, support areas and other facilities where
              consistent cleaning and maintenance routines are important.
            </p>

            <p className="mt-5 text-base leading-7 text-gray-600">
              Auston provides a professional hygiene portfolio supporting
          ...
          <div className="rounded-[2rem] bg-[#F7F9FC] p-8 sm:p-10">
            ...
            <h3 className="mt-6 text-2xl font-bold tracking-tight text-[#071B35]">
              A practical hygiene portfolio for specialised facilities.
            </h3>

            <p className="mt-4 text-sm leading-6 text-gray-600">
              From routine facility cleaning and surface care to janitorial
              tools and equipment, Auston supports multiple areas of
      ...
      <section className="bg-[#F7F9FC] py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
              Supporting everyday facility hygiene.
            </h2>

            <p className="mt-5 text-base leading-7 text-gray-600">
              Professional hygiene products can support cleaning and
              maintenance requirements across different areas of a life
              science facility.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
                Solutions aligned with facility requirements.
              </h2>

              <p className="mt-5 text-base leading-7 text-gray-600">
                Different life science facilities have different workflows
                and cleaning requirements. Auston supports a range of routine
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Professional products for specialised facilities.
              </h2>
      ...
      <section className="bg-[#F7F9FC] py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-6 text-center sm:px-8">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#071B35] sm:text-4xl">
            Looking for professional life science hygiene solutions?
          </h2>
